...
// For GitHub Pages deployment at https://htc85235-jpg.github.io/cssbesthub/
// basePath + assetPrefix must match the repo name. Images and static assets
// are served from /cssbesthub/..., not /.
const isGithubPages = process.env.GITHUB_ACTIONS === "true";
const repo = "cssbesthub";
...
const nextConfig: NextConfig = {
  ...
  // Serve all assets under /cssbesthub/... so they resolve on Pages.
