      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          >
            ...
            partnered with{" "}
            <span className="font-semibold text-emerald">CSS Aspirants</span> to give
          ...
          <div className="relative grid lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 text-cream">
              ...
              <p className="mt-4 text-cream/80 text-sm sm:text-base leading-relaxed max-w-xl">
                CSS Aspirants hosts the complete, downloadable PDF syllabus for all
              ...
              {/* CTA button */}
              <a
                href="https://cssaspirants.pk/css-syllabus/"
                target="_blank"
        ...
        >
          You will be redirected to CSS Aspirants — Pakistan&apos;s trusted free
