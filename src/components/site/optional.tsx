...
const GROUPS: Group[] = [
  ...
  },
  {
    ...
    subjects: [
      ...
      { name: "Regional Languages", marks: 100, scoring: "High", syllabusLength: "Short" },
      { name: "National & Foreign Languages", marks: 100, scoring: "Medium", syllabusLength: "Short" },
      ...
      { name: "Sociology & Anthropology", marks: 100, scoring: "Medium", syllabusLength: "Short" },
      { name: "Pali", marks: 100, scoring: "Medium", syllabusLength: "Short" },
    ],
  },
];
